        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-6 col-md-10">
            ...
            >
              ...
              <div className="">
                <h4 className="font-size-7 text-dark-cloud mb-7">Do you have a minimum contract length?</h4>
                <p className="font-size-5 pr-md-10 pr-lg-0 mb-0">
We recommend a minimum of three months in order to see how content can help you reach your goals.
                </p>
              </div>
            </div>
          </div>
